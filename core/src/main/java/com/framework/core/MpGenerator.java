...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("/Users/sunhan/Workspace/framework/core/src/main/java");
        gc.setFileOverride(true);
        gc.setActiveRecord(true);
        gc.setEnableCache(false);// XML 二级缓存
        gc.setBaseResultMap(false);// XML ResultMap
        gc.setBaseColumnList(false);// XML columList
        gc.setAuthor("Sun.Han");
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/framework?characterEncoding=utf8");
        mpg.setDataSource(dsc);
        // 策略配置
        StrategyConfig strategy = new StrategyConfig();
        strategy.setTablePrefix(new String[]{"sys_"});// 此处可以修改为您的表前缀
        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
        strategy.setInclude(new String[]{"sys_error_message"}); // 需要生成的表
...
//        strategy.setEntityBuliderModel(true);
        ...
        pc.setParent("com.framework.core.modules");
